...
//display SPECIFIC
  ...
  #include <SPI.h>
  #ifndef ST7789_DRIVER_NEW_SENSORS
    #error "wrong display configured - change the line in User_Setup_Select.h file accordingly"
    #error "PLEASE include <../0-ZH_library/TFT_eSPI_display_setups/ZH_ST7789-NEW-SENSORS.h"
  #endif
  #ifndef ST7789_LCD_LED_GPIO
    #error "ST7789_LCD requires ST7789_LCD_LED_GPIO"
  #endif
  #ifdef ST7789_LCD_PWM
    #define LCD_PWM_CHANNEL 1
    #define LCD_PWM_RESOLUTION 8
    #define LCD_PWM_FREQ 5000
    #define LCD_MIN_DC 10
    #define LCD_MAX_DC 255
  #endif
  TFT_eSPI tft = TFT_eSPI();  // Invoke library
  #define TFT_GREY 0x5AEB // New colour
  #define TFT_LIGHTGREY_2 0xBDF7
  #define TFT_CYAN_2 0x7FF
#endif
...
void setup()
{
  ...
  // display SPECIFIC
      ...
      ledcAttachPin(ST7789_LCD_LED_GPIO, LCD_PWM_CHANNEL);
      ledcWrite(LCD_PWM_CHANNEL, 255); //initial dutycycle
    #else
      pinMode(ST7789_LCD_LED_GPIO, OUTPUT);
      digitalWrite(ST7789_LCD_LED_GPIO,HIGH);
    #endif
    tft.init();
    tft.setRotation(ST7789_LCD_ROTATION);
