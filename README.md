...
<ul>
  <li>SHT31 temperature and humidity sensor, I2C, around 1.5$ on Aliexpress (breakout) <b>EDIT: alternatively DS18B20 or MAX31855</b>
  <li>TSL2561 light sensor, I2C, around 1.5$ on Aliexpress (breakout)
  <li>MAX17048 LiPo battery sensor, I2C 1-5$ (depending if chip only or breakout) <b>EDIT: alternatively ADC with resistors</b>
...
<br>
<br>
Next is the file with credentials: passwords.h <s>(ssid, password, webserver where your firmware is stored) - this file is only used for OTA.<br>
<br></s>
